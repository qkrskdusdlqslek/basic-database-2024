...
ALTER TABLE NewBook
	ADD CONSTRAINT R_4 FOREIGN KEY (pubname) REFERENCES NewPublisher(pubname)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE NewOrder
	ADD CONSTRAINT R_5 FOREIGN KEY (bookid) REFERENCES NewBook(bookid)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE NewOrder
	ADD CONSTRAINT R_7 FOREIGN KEY (custid) REFERENCES NewCustomer(custid)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
